...
func (_m *Client) GetPersistentVolumeClaim(ctx context.Context, name string, namespace string) (*v1.PersistentVolumeClaim, error) {
...
func (_m *Client) GetPod(ctx context.Context, name string, namespace string) (*v1.Pod, error) {
	ret := _m.Called(ctx, name, namespace)
...
func (_m *Client) GetService(ctx context.Context, name string, namespace string) (*v1.Service, error) {
	ret := _m.Called(ctx, name, namespace)
